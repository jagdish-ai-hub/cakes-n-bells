      ...
      <div className="space-y-6">
        <div>
          ...
          <input 
            ...
            className={`w-full p-4 bg-white rounded-xl border-2 transition-all focus:border-pink-500 outline-none ${errors.fullName ? 'border-red-300' : 'border-gray-100'}`}
            value={form.fullName}
        ...
        <div>
          ...
          <input 
            ...
            className={`w-full p-4 bg-white rounded-xl border-2 transition-all focus:border-pink-500 outline-none ${errors.mobile ? 'border-red-300' : 'border-gray-100'}`}
            value={form.mobile}
        ...
        <div>
          ...
          <textarea 
            ...
            className={`w-full p-4 bg-white rounded-xl border-2 transition-all focus:border-pink-500 outline-none resize-none ${errors.address ? 'border-red-300' : 'border-gray-100'}`}
            value={form.address}
